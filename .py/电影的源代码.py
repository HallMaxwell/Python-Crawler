...
class APP:
	def __init__(self, width = 500, height = 250):
		...
		play = tk.Button(frame_2, text = "电脑端播放", font = ('微软雅黑',12), fg = 'Purple', width = 8, height = 1, command = self.video_play)
		label3 = tk.Label(frame_2, text = " ")
		# download = tk.Button(frame_2, text = "下载", font = ('微软雅黑',12), fg = 'Purple', width = 2, height = 1, command = self.download_wmxz)
		QR_Code = tk.Button(frame_3, text = "手机端播放", font = ('微软雅黑',12), fg = 'Purple', width = 10, height = 2, command = self.QR_Code)
		label_explain = tk.Label(frame_3, fg = 'GREEN', font = ('微软雅黑',12), text = '\n支持大部分主流视频网站的视频播放')
